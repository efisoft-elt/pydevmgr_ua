...
setup(
    ...
    install_requires=[ 'cryptography', 'opcua', 
        # 'pydevmgr_core>=0.6.a0',
        'pydevmgr_core @ git+https://github.com/efisoft-elt/pydevmgr_core.git@issue2#egg=pydevmgr_core>=0.6.a0',
                ], 
